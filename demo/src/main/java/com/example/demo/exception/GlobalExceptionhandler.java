...
import com.example.demo.model.errorebject.ErrorObject;
...
public class GlobalExceptionhandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorObject> handleExpenseNotFoundExcption(ResourceNotFoundException ex, WebRequest request) {
